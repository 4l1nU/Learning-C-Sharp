...
namespace Json.Facts
{
    public class JsonNumberFacts
    {
        ...
        {
            Assert.False(IsJsonNumber(".1e+1"));
        }

        [Fact]
        public void IsNotOnlyExponent()
        {
            Assert.False(IsJsonNumber("e+1"));
        }

        [Fact]
        public void IsNotOnlyMinusSign()
        {
            Assert.False(IsJsonNumber("-"));
        }

        [Fact]
        public void IsNotOnlyDot()
        {
            Assert.False(IsJsonNumber("."));
        }
        ...
        {
            Assert.False(IsJsonNumber("1.e1"));
        }
    }
}
