...
namespace Collections
{
    public class RadixTrie
    {
        ...
        public class Node
        {
            ...
            {
                Label = "";
                SubNodes = new System.Collections.Generic.List<Node>();
            }
            ...
            public string Label;
            public System.Collections.Generic.List<Node> SubNodes;
        }
        ...
        public class Tree
        {
            ...
            private void InsertRec(string wordPart, Node curNode)
            {
                ...
                {
                    //in this case we have two nodes that we must add to the tree
